export const skillsData = [
  ...
  { name: "CSS3", colorIcon: "group-hover:text-blue-500" },
  { name: "TailwindCSS", colorIcon: "group-hover:text-green-500" },
  { name: "SASS", colorIcon: "group-hover:text-pink-400" },
  { name: "RESTful APIs", colorIcon: "group-hover:text-orange-400" },
  { name: "NodeJS", colorIcon: "group-hover:text-green-600" },
  { name: "ExpressJS", colorIcon: "group-hover:text-black" },
